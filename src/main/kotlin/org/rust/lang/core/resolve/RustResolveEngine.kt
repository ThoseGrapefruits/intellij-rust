...
object RustResolveEngine {
    ...
    fun resolveImportSpec(ref: RustImportSpec): ResolveResult {
        return resolveImportSpec(ref, HashSet())
    }
    ...
    private fun resolveImportSpec(ref: RustImportSpec, visited: MutableSet<RustUseItem>): ResolveResult {
        val basePath = ref.parentOfType<RustUseItem>()?.viewPath?.pathPart ?: return ResolveResult.UNRESOLVED

        // NOTE(matklad): this is not necessary a module
